...
class VideoAnomalyDataset(Dataset):
    ...
    def save_objects(self):
        ...
        for i in tqdm(range(len(self.objects_list))):
            ...
            video_dir = os.path.join(DATA_DIR, f"{self.dataset}_patches", self.phase, record["video_name"])
...
if __name__ == '__main__':
    ...
    shanghai_dataset = VideoAnomalyDataset(data_dir=DATA_DIR + args.dataset + '_frames/' + args.phase + 'ing/',
